...
Linux ordinarily requires `CAP_SYS_ADMIN` for `CLONE_NEWNET`. Run FieldKit through an appropriately constrained container or service account; do not grant broader host privileges solely for convenience.
