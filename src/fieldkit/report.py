...
def render_report(manifest, decision):
    ...
    return f"""<!doctype html><html><head><meta charset='utf-8'><title>FieldKit report</title>
...
<body><p>FIELDKIT / DEPLOYMENT EVIDENCE</p><h1>{html.escape(manifest['benchmark']['name'])}</h1>
